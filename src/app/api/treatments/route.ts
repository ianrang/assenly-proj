...
// G-2: findAllTreatments 재사용 (offset→page 변환).
// ============================================================
...
export async function GET(req: Request) {
  ...
  const { skin_types, concerns, category, budget_max, max_downtime, search } = parsed.data;
  ...
  // 5. 목록 조회 (G-2: findAllTreatments 재사용)
  try {
