...
| P2-56r | AI 분류 정확도 PoC (U-1)                          | **완료 (2026-03-30)**. classify-accuracy.ts. M1 10건 Jaccard 유사도 비교. PocRunConfig로 프롬프트/모델/기준 매개변수화. 반복 실행 가능. 테스트 16개. **⚠️ 실제 AI 실행은 .env 설정 후 `npx tsx` 실행 필요**        | P2-56l         | ✅   |
